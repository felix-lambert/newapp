module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uncss: {
       dist: {
          options: {
             ignore: ['frontend/stylesheets/font-awesome.css'],
             ignoreSheets: [''],
          },
          files: {
             'frontend/stylesheets/unused-removed.css':
             [
              'frontend/views/index.html'
            ]
          }
    ...
    uglify: {
      build: {
        src: [
            ...
            'frontend/angularLib/ngStorage.js',
            'frontend/angularLib/toaster.js',
            'frontend/angularLib/ui-bootstrap-tpls.min.js',
            'frontend/angularLib/angular-css.min.js',
            'frontend/angularLib/angular-file-upload.js',
            'frontend/angularLib/angular-wurfl-image-tailor.js',
            'frontend/angularLib/http-auth-interceptor.js',
  ...
  // Default task(s).
  grunt.registerTask('heroku', ['uglify', 'cssmin', 'uncss']);
